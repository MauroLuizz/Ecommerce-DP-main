            ...
            foreach ($lerCompras->getResultado() as $carrinho) {
                ...
                if ($prod) {
                    ...
                    foreach ($lerCompras->getResultado() as $produto) {
                        ...
                        $clientId = 'Client_Id_8f572a6d6357a3196f075a44b24fc37798b081d2'; // insira seu Client_Id, conforme o ambiente (Des ou Prod)
                        $clientSecret = 'Client_Secret_c0db1cb5330806064f078e541d40347cbe58bf5b'; // insira seu Client_Secret, conforme o ambiente (Des ou Prod)
